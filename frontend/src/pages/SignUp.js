...
export default function SignUp() {
  ...
  /**
   * handles form submit for sign up. sends post request for sign up, gets token and set local storage.
   * sets error message for failed request.
   *
  ...
  const handleSubmit = async (e) => {
    ...
    const genericErrorMessage =
      "Etwas ist schief gegangen, versuchen Sie es erneut.";
